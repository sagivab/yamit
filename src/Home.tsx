...
function YamitPage() {
  ...
  const items = [
    ...
    },
    {
      ...
      details: (
        <p className="text-lg leading-7 text-black/80">
          מוצרי קוסמטיקה טבעית בעבודת יד, מתוך הקשבה לעור ולמה שהוא באמת צריך.
          כל מוצר נרקח במיוחד עבורך, משילוב מדויק של רכיבים טבעיים וצמחי מרפא,
          כדי להזין, להרגיע ולחזק את העור בצורה טבעית ובריאה.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      details: (
        <p className="text-lg leading-7 text-black/80">
          הרצאות וסדנאות חווייתיות שמחברות ידע מעשי עם חיי היומיום. ההרצאות
          עוסקות באורח חיים בריא, תזונה, איזון והרגלים פשוטים שניתן ליישם כבר
          מהיום. הסדנאות מתמקדות בקוסמטיקה טבעית - היכרות עם חומרי גלם מן הטבע,
          רקיחה בעבודת יד ויצירה של מוצרי טיפוח טבעיים, תוך חוויה למידה וחיבור
          לעצמנו.
        </p>
      ),
    },
    ...
    <div className="min-h-screen max-w-screen-sm mx-auto flex flex-col items-center px-10 py-10 relative bg-[#e7dfd1] text-[#1f1f1f]">
      ...
      <main className="min-h-screen max-w-screen-sm mx-auto flex flex-col items-center  py-10 relative bg-[#e7dfd1] text-[#1f1f1f]">
        ...
        >
          ...
          מלווה נשים לאורח חיים בריא, איזון הורמונלי וירידה במשקל. חיה ונושמת
          אורח חיים בריא, יודעת שהשליחות האמיתית שלי היא לעזור לנשים להגיע
          לבריאות מיטבית ולהרגיש טוב בגוף שלהן בדגש על איזון הורמונלי בתקופת
          המחזור ובגיל המעבר. הגישה שלי מבוססת על פשטות ושינויים הדרגתיים - בלי
          דיאטות קיצוניות. אני כאן כדי ללוות אותך בדרך לבריאות מאוזנת, עם כלים
          מעשיים שיעזרו לך להרגיש טוב יותר, לישון טוב יותר ולחיות באנרגיה גבוהה
        </p>
  ...
  `}
          >
            {/* קונטיינר האייקון - שומר על עיגול מושלם בכל גודל מסך */}
